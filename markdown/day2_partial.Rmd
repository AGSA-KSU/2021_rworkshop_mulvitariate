...
CF_varimp = CF_varimp %>% set_colnames(c('folds','var','cimp'))
...
# plot permimp
cimp.cf.final %>% set_colnames(c('var','varimp','absimp')) %>% ggplot()+
  geom_col(aes(y=fct_reorder(var, absimp), x=absimp))+
  labs(x = 'Conditional Importance', y = "Feature")+
  theme_bw()
